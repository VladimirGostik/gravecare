...
const OrderCompletedUser = ({ order, onClose }) => {
            ...
            <div className="bg-white p-3 rounded-[30px] shadow-sm w-full max-w-2xl relative">
                ...
                <div className="flex justify-between">
                    ...
                    <div className="bg-backroundPurple p-3 rounded-2xl w-[40%]">
                        <p className="mx-2"><strong>Dodávateľ:</strong></p>
                        <div className="bg-customSideBar rounded-xl w-full p-1 px-2">{order.entrepreneurName}</div>
                        <p className="mx-2 mt-2"><strong>Cintorín:</strong></p>
                        <div className="bg-customSideBar rounded-xl w-full p-1 px-2">{order.cemeteryName}</div>
...
export default OrderCompletedUser;